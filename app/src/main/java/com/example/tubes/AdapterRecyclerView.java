...
import com.example.tubes.databinding.ActivityAdapterRecyclerViewBinding;
...
public class AdapterRecyclerView extends RecyclerView.Adapter<AdapterRecyclerView.MyViewHolder> {
    ...
    private ActivityAdapterRecyclerViewBinding adapterbinding;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        adapterbinding = ActivityAdapterRecyclerViewBinding.inflate(layoutInflater, parent, false);
