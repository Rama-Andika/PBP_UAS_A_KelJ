...
public class JustShowRoomAdapter extends RecyclerView.Adapter<JustShowRoomAdapter.RoomViewHolder> implements Filterable {
    private List<RoomDAO> dataList;
    private List<RoomDAO> filteredDataList;
    private Context context;

    public JustShowRoomAdapter(Context context, List<RoomDAO> dataList){
    ...
    @Override
    public void onBindViewHolder(@NonNull JustShowRoomAdapter.RoomViewHolder holder, int position) {
